<?php
namespace App\KeycloakGuard;

use Illuminate\Contracts\Auth\Guard;
use Illuminate\Contracts\Auth\Authenticatable;
use Illuminate\Contracts\Auth\UserProvider;
use Illuminate\Http\Request;
use App\KeycloakGuard\Exceptions\TokenException;
use App\KeycloakGuard\Exceptions\UserNotFoundException;
use App\KeycloakGuard\Exceptions\ResourceAccessNotAllowedException;
